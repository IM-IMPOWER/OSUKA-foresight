export const jaJP = {
  ...
  sources: {
    ...
    addYoutube: "YouTube ソースを追加",
    addYoutubeDesc: "YouTube リンクを貼り付けて字幕をソースとして追加します。",
    invalidYoutubeUrl: "有効な YouTube URL を入力してください。",
    youtubeAddedSuccess: "YouTube ソースを追加しました。",
