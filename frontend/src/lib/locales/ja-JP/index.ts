export const jaJP = {
  ...
  navigation: {
    ...
    search: "検索",
    ask: "質問",
    osuka: "OSUKA Discovery",
  },
  osuka: {
    title: "OSUKA Discovery",
    description: "Run OSUKA product discovery and generate specs tables.",
    ...
    logsStarting: "OSUKA: starting discovery...",
    logsRequestSent: "OSUKA: request sent...",
    logsResponseReceived: "OSUKA: response received",
  },
  notebooks: {
    title: "ノートブック",
    newNotebook: "新規ノートブック",
