export const ptBR = {
  ...
  osuka: {
    title: "Discovery",
    description: "Run product discovery and generate specs tables.",
    formTitle: "Run Discovery",
    formDescription: "Provide a category and optional market (leave blank for global).",
    categoryLabel: "Category",
    categoryPlaceholder: "e.g. Cordless drills",
    marketLabel: "Market (optional, global if blank)",
    marketPlaceholder: "e.g., Thailand",
    allowExternalLabel: "Allow external brands",
    preferPdfsLabel: "Prefer catalogue/manual PDFs (over product pages)",
    preferredBrandsLabel: "Preferred brands (optional)",
    preferredBrandsPlaceholder: "makita, bosch, dewalt",
    runButton: "Run discovery",
    maxTotalLabel: "Max products",
    resultsTitle: "Results",
    productsFound: "Products found: {count}",
    sourcesAdded: "Sources added: {count}",
    openNotebook: "Open notebook",
    openChat: "Open chat session",
    tableTitle: "Specs Table",
    tableDescription: "Generated from the discovered sources.",
    tablePrompt: "Create a specs table for all products across all brands. Normalize similar attributes, include brand and product name, and use '-' for missing values.",
    chatYou: "You",
    chatModel: "Model",
    logsTitle: "Discovery Logs",
    logsDescription: "Progress output from the discovery pipeline.",
    logsStarting: "Starting discovery...",
    logsRequestSent: "Request sent...",
    logsResponseReceived: "Response received",
  },
  notebooks: {
    title: "Cadernos",
    newNotebook: "Novo Caderno",
  ...
  sources: {
    ...
    addYoutube: "Adicionar Fonte do YouTube",
    addYoutubeDesc: "Cole um link do YouTube para adicionar a transcrição como fonte.",
    invalidYoutubeUrl: "Insira uma URL válida do YouTube.",
    youtubeAddedSuccess: "Fonte do YouTube adicionada.",
