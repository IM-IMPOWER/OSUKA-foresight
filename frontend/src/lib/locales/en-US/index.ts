export const enUS = {
  ...
  osuka: {
    ...
    preferredBrandsPlaceholder: "brand1, brand2, brand3",
  ...
  sources: {
    ...
    addYoutube: "Add YouTube Source",
    addYoutubeDesc: "Paste a YouTube link to add its transcript as a source.",
    invalidYoutubeUrl: "Please enter a valid YouTube URL.",
    youtubeAddedSuccess: "YouTube source added.",
